...
| **_Swift_**      | 🌔 **full** · tree-sitter                                                                                         | 🌖 **high** · XCTest + swift-testing recognition (test cases, setUp/tearDown, @Test/@Suite) plus Quick/Nimble DSL scope chunking (per-scenario chunks with ancestor beforeEach spliced in) | 🌗 **moderate** — 7-strategy chain + implicit-self field typing + extension-scope and nested-type receivers + file-local typing; no import narrowing (imports name modules)                 |
