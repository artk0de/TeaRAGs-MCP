...
| **_Swift_**      | 🌔 **full** · tree-sitter                                                                                         | 🌖 **high** · XCTest + swift-testing recognition (test cases, setUp/tearDown, @Test/@Suite); nesting via types, not a DSL scope tree | 🌗 **moderate** — 6-strategy chain + implicit-self field typing + extension-scope member resolution; no import narrowing (Swift imports name modules)                                       |
