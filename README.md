...
| **_Swift_**      | 🌔 **full** · tree-sitter                                                                                         | 🌖 **high** · XCTest + swift-testing recognition (test cases, setUp/tearDown, @Test/@Suite) plus Quick/Nimble DSL scope chunking (per-scenario chunks with ancestor beforeEach spliced in) | 🌗 **moderate** — 8-strategy chain + super over the superclass chain + implicit-self field typing + extension-scope and nested-type receivers; no import narrowing                          |
