...
- Cross-process DuckDB daemon becomes the default graph backend — single writer
  holds the lock, all readers proxy through a socket, and the lock is released
  on idle so concurrent processes no longer collide
...
- Static call resolution now follows receiver and variable types across Python
  (inherited methods, self.field, stdlib), Go (receiver/local/return types),
  Java (param/field/local types, java.lang statics), TypeScript (typed params,
  named imports, same-file collisions) and Rust (local bindings, struct fields)
  ...
  [5ae7cec](https://github.com/artk0de/TeaRAGs-MCP/commit/5ae7cec),
  [d60573b](https://github.com/artk0de/TeaRAGs-MCP/commit/d60573b))
- Graph signals are exposed for ranking and filtering — connectionCount +
  instability confidence, typed filter params, chunk-level signal wiring, and
  hub detection against collection p95
  ([dbdec9e](https://github.com/artk0de/TeaRAGs-MCP/commit/dbdec9e),
  [973620c](https://github.com/artk0de/TeaRAGs-MCP/commit/973620c),
  [169211c](https://github.com/artk0de/TeaRAGs-MCP/commit/169211c),
...
- Enrichment runs streaming per-batch with no prefetch gate and codegraph
  deferred to a post-finalize pass, removing the false-stall window that flagged
  long index runs as hung
...
- Per-file enrichment policy skips generated and doc files, reporting them as
  ignoredFiles distinct from missedFiles, and applies on backfill + recovery
  paths ([9ca0f07](https://github.com/artk0de/TeaRAGs-MCP/commit/9ca0f07),
  [b534c2c](https://github.com/artk0de/TeaRAGs-MCP/commit/b534c2c),
  [b075d56](https://github.com/artk0de/TeaRAGs-MCP/commit/b075d56),
  [7e49de6](https://github.com/artk0de/TeaRAGs-MCP/commit/7e49de6),
  [727b8ff](https://github.com/artk0de/TeaRAGs-MCP/commit/727b8ff))
- Codegraph DuckDB files are cleaned up with their Qdrant collections on
  alias-swap and orphan sweep, and the daemon is kept alive across a full index
  run ([263573d](https://github.com/artk0de/TeaRAGs-MCP/commit/263573d),
  [0117819](https://github.com/artk0de/TeaRAGs-MCP/commit/0117819),
  [fbc2aeb](https://github.com/artk0de/TeaRAGs-MCP/commit/fbc2aeb))

### language

- All nine languages (ruby, typescript, javascript, python, go, java, rust,
  bash, markdown) are now native LanguageProvider verticals built by a real
  LanguageFactory; the legacy adapter path is removed
  ([951e3a0](https://github.com/artk0de/TeaRAGs-MCP/commit/951e3a0),
  [cfc4c19](https://github.com/artk0de/TeaRAGs-MCP/commit/cfc4c19),
  [9e63d07](https://github.com/artk0de/TeaRAGs-MCP/commit/9e63d07),
  [07b09cd](https://github.com/artk0de/TeaRAGs-MCP/commit/07b09cd),
  [6a3fded](https://github.com/artk0de/TeaRAGs-MCP/commit/6a3fded),
  [8a094bb](https://github.com/artk0de/TeaRAGs-MCP/commit/8a094bb),
  [9ec3c35](https://github.com/artk0de/TeaRAGs-MCP/commit/9ec3c35),
  [0f024c8](https://github.com/artk0de/TeaRAGs-MCP/commit/0f024c8),
  [11289c0](https://github.com/artk0de/TeaRAGs-MCP/commit/11289c0),
  [4aab0d1](https://github.com/artk0de/TeaRAGs-MCP/commit/4aab0d1),
  [7a83c49](https://github.com/artk0de/TeaRAGs-MCP/commit/7a83c49))
- Per-language call resolvers are decomposed into a three-state
  SymbolResolutionStrategy chain across all 7 resolving languages
  ([e091d0a](https://github.com/artk0de/TeaRAGs-MCP/commit/e091d0a),
  [faa120a](https://github.com/artk0de/TeaRAGs-MCP/commit/faa120a))
- Ruby class-body declarations are driven by a single DSL catalogue, and chunk
  classification routes through a language-agnostic ChunkClassifier (Go + JS
  classifiers added)
  ...
  [53441d4](https://github.com/artk0de/TeaRAGs-MCP/commit/53441d4),
  [9dd292f](https://github.com/artk0de/TeaRAGs-MCP/commit/9dd292f))

### config

- BREAKING: CODEGRAPH_ENABLED now defaults to false — codegraph signals and the
  get_callers/get_callees/find_cycles tools require setting it true and
  re-indexing. The full dependency-direction layer matrix is now enforced in the
  eslint guard
...
- Blame and churn extraction switches to a persistent `git cat-file --batch`
  reader shared across batches, dropping the isomorphic-git dependency
  ([288268a](https://github.com/artk0de/TeaRAGs-MCP/commit/288268a),
  [28a8358](https://github.com/artk0de/TeaRAGs-MCP/commit/28a8358),
  [4cf151f](https://github.com/artk0de/TeaRAGs-MCP/commit/4cf151f))

### api

- api/public is widened into the single consumer facade, with cli and mcp
  importing core only through it
  ([77d79ab](https://github.com/artk0de/TeaRAGs-MCP/commit/77d79ab),
  [8e1bc89](https://github.com/artk0de/TeaRAGs-MCP/commit/8e1bc89),
  [c8e19be](https://github.com/artk0de/TeaRAGs-MCP/commit/c8e19be))

### small fixes and improvements

- Design specs, implementation plans and architecture rules for the codegraph
  daemon, enrichment worker pool, domains/language consolidation, per-file
  policy and TS resolver
  ([44b29a5](https://github.com/artk0de/TeaRAGs-MCP/commit/44b29a5),
  [250fdf3](https://github.com/artk0de/TeaRAGs-MCP/commit/250fdf3),
  [20cdd66](https://github.com/artk0de/TeaRAGs-MCP/commit/20cdd66),
  [db5b8d4](https://github.com/artk0de/TeaRAGs-MCP/commit/db5b8d4),
  [9e3c48e](https://github.com/artk0de/TeaRAGs-MCP/commit/9e3c48e),
  [c816983](https://github.com/artk0de/TeaRAGs-MCP/commit/c816983),
  [750ca4f](https://github.com/artk0de/TeaRAGs-MCP/commit/750ca4f),
  [f063d00](https://github.com/artk0de/TeaRAGs-MCP/commit/f063d00),
  [c1227e4](https://github.com/artk0de/TeaRAGs-MCP/commit/c1227e4))
- Internal type relocations into contracts, DI seam extraction, and
  module-boundary tightening with no behavior change
  ([f99f5cf](https://github.com/artk0de/TeaRAGs-MCP/commit/f99f5cf),
  [16dceee](https://github.com/artk0de/TeaRAGs-MCP/commit/16dceee),
  [9344854](https://github.com/artk0de/TeaRAGs-MCP/commit/9344854),
  [bdb644f](https://github.com/artk0de/TeaRAGs-MCP/commit/bdb644f),
  [3ea227c](https://github.com/artk0de/TeaRAGs-MCP/commit/3ea227c),
  [786d021](https://github.com/artk0de/TeaRAGs-MCP/commit/786d021))
- Registry alias rename on re-register, embedding-endpoint surfacing in prime,
  qdrant reconnect re-resolution, and CLI prime exit fix
  ([63d9be2](https://github.com/artk0de/TeaRAGs-MCP/commit/63d9be2),
  ...
  [a05631a](https://github.com/artk0de/TeaRAGs-MCP/commit/a05631a))
