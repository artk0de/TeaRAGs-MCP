...
- **adapters:** loud daemon capability handshake instead of silent fallbacks
  (39xca.4)
  ([16aaaa2](https://github.com/artk0de/TeaRAGs-MCP/commit/16aaaa231b26808eb2a76a6d8157a58458e8c6c1))
- **migration:** persist cg_symbols line ranges and read them per file (9i2ow)
  ([1168237](https://github.com/artk0de/TeaRAGs-MCP/commit/11682370642cb9db58e6331a96d856dda5bef9e0))

### Improvements

- **adapters:** refuse to create a shadow codegraph database (39xca.1)
  ([4eefe95](https://github.com/artk0de/TeaRAGs-MCP/commit/4eefe955491a7aef7ba857d8339a8f607072476f)),
  closes
  [GraphDbClientPool#openCollection](https://github.com/artk0de/GraphDbClientPool/issues/openCollection)
  [CodegraphDbFiles#cloneDatabase](https://github.com/artk0de/CodegraphDbFiles/issues/cloneDatabase)
  [CodegraphDbFiles#writablePathFor](https://github.com/artk0de/CodegraphDbFiles/issues/writablePathFor)
- **cli:** prime shows plain resolve warnings by default, receiver-kind detail
  under DEBUG
  ([c5acb32](https://github.com/artk0de/TeaRAGs-MCP/commit/c5acb32b353a669ade7fe16a944712383448cbc1))
- **language:** short codegraph summaries in the README language table (wjjjj)
  ([949fbf9](https://github.com/artk0de/TeaRAGs-MCP/commit/949fbf92f8da843b9061b04560b0b50a1201a4c9))
- **mcp:** outline and TOC lines are find_symbol addresses in agent guidance
  (u74dj)
  ([7064ff6](https://github.com/artk0de/TeaRAGs-MCP/commit/7064ff6bbe9c3d5eef6e83797d187e5e0ffd1822))

### Bug Fixes

- **adapters:** aggregate resolve stats from per-file tallies (xpmwg)
  ([b6d072a](https://github.com/artk0de/TeaRAGs-MCP/commit/b6d072aadad71ed37d3d6e7774e956df71a04763))
- **adapters:** carry the spawner resolved debug flag into the codegraph daemon
  (gnig6)
  ([7d5218b](https://github.com/artk0de/TeaRAGs-MCP/commit/7d5218b99fd0b3f101fa721d14d66966e4151478)),
  closes
  [GraphDbClientPool#retireStaleClient](https://github.com/artk0de/GraphDbClientPool/issues/retireStaleClient)
  [GraphDbClientPool#cloneDatabase](https://github.com/artk0de/GraphDbClientPool/issues/cloneDatabase)
- **adapters:** close graph sessions for real — drain running calls, no
  checkpoint (amh78)
  ([d32119b](https://github.com/artk0de/TeaRAGs-MCP/commit/d32119b09a2a42c5f742f0290fa858f26575a8f2))
- **adapters:** replace a pooled graph client whose database file is gone
  (amh78)
  ([8f3b227](https://github.com/artk0de/TeaRAGs-MCP/commit/8f3b227c0be8475899534417e488f293daef0f5f)),
  closes
  [CodegraphDbFiles#discardOrphanedWal](https://github.com/artk0de/CodegraphDbFiles/issues/discardOrphanedWal)
  [DaemonMemoryGovernor#forgetCollection](https://github.com/artk0de/DaemonMemoryGovernor/issues/forgetCollection)
- **api:** clear every codegraph generation when an index is cleared (39xca.1)
  ([bfbe895](https://github.com/artk0de/TeaRAGs-MCP/commit/bfbe8956182d645bd4ca99eb3ebcfd2342931283)),
  closes
  [IndexingOps#clear](https://github.com/artk0de/IndexingOps/issues/clear)
  [StatusModule#clearIndex](https://github.com/artk0de/StatusModule/issues/clearIndex)
  [GraphDbClientPool#removeCollection](https://github.com/artk0de/GraphDbClientPool/issues/removeCollection)
- **api:** frame status and metrics health on the project's slice (uebug)
  ([455ec56](https://github.com/artk0de/TeaRAGs-MCP/commit/455ec56e46522eff6fa72e8c6264f1b64988531c)),
  closes
  [ProjectIngestFactory#forPath](https://github.com/artk0de/ProjectIngestFactory/issues/forPath)
  [ProjectIngestFactory#forPath](https://github.com/artk0de/ProjectIngestFactory/issues/forPath)
  [IndexMetricsQuery#run](https://github.com/artk0de/IndexMetricsQuery/issues/run)
- **bootstrap:** respawn the codegraph daemon with the configured memory ceiling
  (8qzyb)
  ([5391e4f](https://github.com/artk0de/TeaRAGs-MCP/commit/5391e4ff9c3071884d6930cea09b83954f09de73))
- **cli:** detached index worker survives the supervisor's detach
  ([8466cf8](https://github.com/artk0de/TeaRAGs-MCP/commit/8466cf8a9229df65973434da560e9e67a9b4978d))
- **cli:** prime renders thresholds for every language with per-language stats
  ([8c6e80c](https://github.com/artk0de/TeaRAGs-MCP/commit/8c6e80cce3d004f5ec31198f86411b0fe6989c38))
- **cli:** reconcile a fresh update-check cache with the installed version
  (xsjh1)
  ([0c611bf](https://github.com/artk0de/TeaRAGs-MCP/commit/0c611bf5f6ad33506df859d1d24ac94ab77f0cf7)),
  closes
  [UpdateCheckService#checkForUpdate](https://github.com/artk0de/UpdateCheckService/issues/checkForUpdate)
- **explore:** doc TOC ids name each heading's own section, ancestors get none
  (mypsl)
  ([50d128f](https://github.com/artk0de/TeaRAGs-MCP/commit/50d128f26f8c2d168e2eeeccafe9653f890effb7))
- **explore:** enforce pathPattern exactly after the Qdrant text pre-filter
  (xf01b)
  ([d3d3037](https://github.com/artk0de/TeaRAGs-MCP/commit/d3d30373478e9462d958dfab21084fe3c8947b9b)),
  closes
  [BaseExploreStrategy#postProcess](https://github.com/artk0de/BaseExploreStrategy/issues/postProcess)
  [ScrollRankStrategy#postProcess](https://github.com/artk0de/ScrollRankStrategy/issues/postProcess)
- **explore:** find_symbol class outline without tests, doc section returns
  content (u74dj)
  ([f70ba04](https://github.com/artk0de/TeaRAGs-MCP/commit/f70ba04b26af86e68b27d5fb710566747e302446))
- **explore:** find_symbol degrades instead of failing when codegraph is
  unavailable (a43tr)
  ([0b4f251](https://github.com/artk0de/TeaRAGs-MCP/commit/0b4f251adbad3488f1f528f82a56d73699c13c38)),
  closes
  [GraphFacade#withReadHandle](https://github.com/artk0de/GraphFacade/issues/withReadHandle)
  [SymbolSearchStrategy#resolveCoveringChunk](https://github.com/artk0de/SymbolSearchStrategy/issues/resolveCoveringChunk)
  [GraphFacade#withReadHandle](https://github.com/artk0de/GraphFacade/issues/withReadHandle)
  [DaemonGraphDbClient#init](https://github.com/artk0de/DaemonGraphDbClient/issues/init)
  [GraphDbClientPool#acquireRead](https://github.com/artk0de/GraphDbClientPool/issues/acquireRead)
- **explore:** order rank_chunks scrolls by the stored path of codegraph signals
  (xf01b)
  ([49a96c0](https://github.com/artk0de/TeaRAGs-MCP/commit/49a96c00b752e6b4a07373d14c72973cc8c5b34c)),
  closes
  [RankModule#resolvePayloadField](https://github.com/artk0de/RankModule/issues/resolvePayloadField)
- **explore:** rank a symbol's own chunks first for identifier hybrid queries
  (2fefq)
  ([fb0b08e](https://github.com/artk0de/TeaRAGs-MCP/commit/fb0b08e0bf944c9308e80c55ad07c08cbc9a6c2c)),
  closes
  [QdrantSearchExecutor#hybridSearch](https://github.com/artk0de/QdrantSearchExecutor/issues/hybridSearch)
- **explore:** read single-alternative braces in pathPattern as the pre-filter
  does (xf01b)
  ([67770ed](https://github.com/artk0de/TeaRAGs-MCP/commit/67770ed2fc9c01312f3b3212b4aabac79710eaa9))
- **explore:** stitch doc section windows by text overlap, not whole lines
  (u74dj)
  ([753a395](https://github.com/artk0de/TeaRAGs-MCP/commit/753a395232aeb3225564a9223935e069ea95de09))
- **ingest:** claim a collection for indexing with an exclusive lockfile
  (39xca.13)
  ([caf1442](https://github.com/artk0de/TeaRAGs-MCP/commit/caf14426ed580fee9868c3830b223cec7c5d17db)),
  closes
  [IndexingOps#claimCollectionForIndexing](https://github.com/artk0de/IndexingOps/issues/claimCollectionForIndexing)
  [ReindexPipeline#closeRun](https://github.com/artk0de/ReindexPipeline/issues/closeRun)
- **ingest:** count real chunks only, one service-point definition (39xca.12)
  ([924188a](https://github.com/artk0de/TeaRAGs-MCP/commit/924188a8ee877bc6e28e229fc9d972d9d248177e)),
  closes
  [IndexingOps#refreshStatsByCollection](https://github.com/artk0de/IndexingOps/issues/refreshStatsByCollection)
  [IndexPipeline#recordRegistryEntry](https://github.com/artk0de/IndexPipeline/issues/recordRegistryEntry)
- **ingest:** pre-reindex recovery addresses the physical collection, not the
  alias
  ([4cb3760](https://github.com/artk0de/TeaRAGs-MCP/commit/4cb3760fa2ebeb9714a3a0a409453ff3596f9c09)),
  closes
  [IndexingOps#tryIncrementalIndex](https://github.com/artk0de/IndexingOps/issues/tryIncrementalIndex)
  [CodegraphEnrichmentProvider#buildChunkSignals](https://github.com/artk0de/CodegraphEnrichmentProvider/issues/buildChunkSignals)
  [GraphDbClientPool#acquireWrite](https://github.com/artk0de/GraphDbClientPool/issues/acquireWrite)
  [CodegraphDbFiles#pathFor](https://github.com/artk0de/CodegraphDbFiles/issues/pathFor)
- **ingest:** registry chunksCount counts real chunks only (39xca.12)
  ([2a4fb56](https://github.com/artk0de/TeaRAGs-MCP/commit/2a4fb56c6199055249f6d291aef652e9b05dfec1)),
  closes
  [BaseIndexingPipeline#recordRegistryEntry](https://github.com/artk0de/BaseIndexingPipeline/issues/recordRegistryEntry)
  [ProjectRegistryOps#tryEnrichFromQdrant](https://github.com/artk0de/ProjectRegistryOps/issues/tryEnrichFromQdrant)
  [ProjectRegistryOps#recoverFromQdrant](https://github.com/artk0de/ProjectRegistryOps/issues/recoverFromQdrant)
- **ingest:** reject an index run while the same collection is indexing (62pgi)
  ([184af4a](https://github.com/artk0de/TeaRAGs-MCP/commit/184af4a6ce3a05e393f8c9b8f603d30e3f19b499)),
  closes [IndexingOps#run](https://github.com/artk0de/IndexingOps/issues/run)
  [EnrichmentCoordinator#whenCompletionsSettled](https://github.com/artk0de/EnrichmentCoordinator/issues/whenCompletionsSettled)
- **migration:** add per-file codegraph resolve stats tables (xpmwg)
  ([1511e4c](https://github.com/artk0de/TeaRAGs-MCP/commit/1511e4cec70241d5e4d1c46ae1a49963924a6536))
- **migration:** give the schema metadata point one owner (906df)
  ([76b5f57](https://github.com/artk0de/TeaRAGs-MCP/commit/76b5f57f77cba4b506df5e029aaad81b73e792b6))
- **pipeline:** a superseded run's failed completion is not unhandled (qiu3o)
  ([3ad2f5d](https://github.com/artk0de/TeaRAGs-MCP/commit/3ad2f5d40f535e4e88bfe696ba55adc3d80a7845)),
  closes
  [EnrichmentCoordinator#createRunState](https://github.com/artk0de/EnrichmentCoordinator/issues/createRunState)
- **pipeline:** payload healer writes each chunk under the symbol that owns it
  (9i2ow)
  ([22ea217](https://github.com/artk0de/TeaRAGs-MCP/commit/22ea217fc9a6c15ca01aaa63053e1107cde047de)),
  closes [#partN](https://github.com/artk0de/TeaRAGs-MCP/issues/partN)
- **pipeline:** persist codegraph resolve stats per caller file (xpmwg)
  ([0a7e372](https://github.com/artk0de/TeaRAGs-MCP/commit/0a7e37287547c092c2e12f53edd8af2e917dc97b))
- **pipeline:** recompute waits for the sync leg's in-flight enrichment run
  (71n0p, u3e77)
  ([301ecc2](https://github.com/artk0de/TeaRAGs-MCP/commit/301ecc25929f727e7bf85d9cddd37a58f1f3f951))
- **pipeline:** recovery hands codegraph chunks to the run's repair walk and
  deferred pass (fxio5)
  ([731dbaa](https://github.com/artk0de/TeaRAGs-MCP/commit/731dbaa6d93673de0abc63489a42116722fa4326)),
  closes
  [EnrichmentRecovery#recoverChunkLevel](https://github.com/artk0de/EnrichmentRecovery/issues/recoverChunkLevel)
  [EnrichmentCoordinator#runRecovery](https://github.com/artk0de/EnrichmentCoordinator/issues/runRecovery)
  [IndexingOps#dispatchRecovery](https://github.com/artk0de/IndexingOps/issues/dispatchRecovery)
  [ReindexPipeline#reindexChanges](https://github.com/artk0de/ReindexPipeline/issues/reindexChanges)
  [EnrichmentCoordinator#narrowDeferredChunkHandoff](https://github.com/artk0de/EnrichmentCoordinator/issues/narrowDeferredChunkHandoff)
- **pipeline:** recovery heals non-extractable codegraph chunks in place, not
  via handoff (fxio5)
  ([087f1a4](https://github.com/artk0de/TeaRAGs-MCP/commit/087f1a4e2ad6c389286b6e2c97eb11f695888b04)),
  closes
  [EnrichmentRecovery#recoverChunkLevel](https://github.com/artk0de/EnrichmentRecovery/issues/recoverChunkLevel)
- **pipeline:** recovery maps codegraph chunks to symbols by payload symbolId
  ([10fe67a](https://github.com/artk0de/TeaRAGs-MCP/commit/10fe67a3480180f3b2403a48d6e9a4efd24eec59)),
  closes
  [EnrichmentRecovery#recoverChunkLevel](https://github.com/artk0de/EnrichmentRecovery/issues/recoverChunkLevel)
  ...
  [#participants](https://github.com/artk0de/TeaRAGs-MCP/issues/participants)
  [#partition_key_for](https://github.com/artk0de/TeaRAGs-MCP/issues/partition_key_for)
- **pipeline:** revert payload-symbolId fallback for recovery chunk mapping
  (fxio5)
  ([7b1e503](https://github.com/artk0de/TeaRAGs-MCP/commit/7b1e503ca841459876aee096195b82dc2ec6f427))
- **pipeline:** settle terminal markers as failed when enrichment completion
  throws (39xca.11)
  ([328c44e](https://github.com/artk0de/TeaRAGs-MCP/commit/328c44ea1c89c596f8998296866d304cc973fab8)),
  closes
  [CompletionRunner#run](https://github.com/artk0de/CompletionRunner/issues/run)
  [EnrichmentCoordinator#completeRun](https://github.com/artk0de/EnrichmentCoordinator/issues/completeRun)
  [CompletionRunner#run](https://github.com/artk0de/CompletionRunner/issues/run)
- **trajectory:** add the one chunk-owner rule both chunk-signal writers use
  (9i2ow)
  ([d8fca9d](https://github.com/artk0de/TeaRAGs-MCP/commit/d8fca9d58f08a7468633431d61f4865b9ad3f247)),
  closes [#partN](https://github.com/artk0de/TeaRAGs-MCP/issues/partN)
  [#constructor](https://github.com/artk0de/TeaRAGs-MCP/issues/constructor)
- **trajectory:** deferred chunk pass maps chunks to owners through the shared
  rule (9i2ow)
  ([97dae41](https://github.com/artk0de/TeaRAGs-MCP/commit/97dae41c7f19fc2e79772f38c352a4a426ab513a)),
  closes
  [ChunkPhase#extractBatchChunkMap](https://github.com/artk0de/ChunkPhase/issues/extractBatchChunkMap)
  [EnrichmentCoordinator#scrollStoredChunks](https://github.com/artk0de/EnrichmentCoordinator/issues/scrollStoredChunks)
- **trajectory:** persist self.table_name overrides an incremental run resolves
  against (39xca.9)
  ([b0a2ddd](https://github.com/artk0de/TeaRAGs-MCP/commit/b0a2ddd5d763f62518a8a89945099af004a92903)),
  closes [Client#code](https://github.com/artk0de/Client/issues/code)
  [Client#juno_key](https://github.com/artk0de/Client/issues/juno_key)
- **trajectory:** registry of run-global map persistence, run-scoped resolver
  memos (39xca.6)
  ([5addc82](https://github.com/artk0de/TeaRAGs-MCP/commit/5addc82253aa7ca90fcdda602bc07e201db673c0))
- **trajectory:** resolve interface-typed calls via declared type, not name
  uniqueness (hwwtw)
  ([4a74db4](https://github.com/artk0de/TeaRAGs-MCP/commit/4a74db45f90715399ad279a0bb2a6290f64eea51)),
  closes
  [CommitDiffMemo#set](https://github.com/artk0de/CommitDiffMemo/issues/set)
  [CallEdgeResolutionRunner#dispatchCall](https://github.com/artk0de/CallEdgeResolutionRunner/issues/dispatchCall)
  [CommitDiffMemo#set](https://github.com/artk0de/CommitDiffMemo/issues/set)
  [CommitDiffMemo#get](https://github.com/artk0de/CommitDiffMemo/issues/get)
  [RunScopedMemo#set](https://github.com/artk0de/RunScopedMemo/issues/set)
  [#get](https://github.com/artk0de/TeaRAGs-MCP/issues/get)
  [JsonProgressRenderer#error](https://github.com/artk0de/JsonProgressRenderer/issues/error)
  [TeaRagsError#toString](https://github.com/artk0de/TeaRagsError/issues/toString)
  [BenchWorker#onMessage](https://github.com/artk0de/BenchWorker/issues/onMessage)
  [LspClient#pid](https://github.com/artk0de/LspClient/issues/pid)
  [Foo#bar](https://github.com/artk0de/Foo/issues/bar)
  [Store#put](https://github.com/artk0de/Store/issues/put)
- **trajectory:** settle codegraph chunk signals through one typed range source
  (39xca.2)
  ([5eb2a2d](https://github.com/artk0de/TeaRAGs-MCP/commit/5eb2a2d1c5f70c86ca09768536f733e90450061f))

### Documentation

- **benchmarks:** search-cascade outline / TOC drill-down eval (u74dj)
  ([ea946ea](https://github.com/artk0de/TeaRAGs-MCP/commit/ea946ea74e28b2a2c857dbcd50e05954cf5623e9))
- **ingest:** document system requirements and measured index disk usage
  ([db8537a](https://github.com/artk0de/TeaRAGs-MCP/commit/db8537ae334af268e9c2ec37c440a813af5afb7d))
- **ingest:** point collection-identity navigators at the brand, not the
  convention (39xca.1)
  ([c448deb](https://github.com/artk0de/TeaRAGs-MCP/commit/c448deb8e3688450978e2c6ecf8d78ac46f7a92c)),
  closes
  [CodegraphDbFiles#writablePathFor](https://github.com/artk0de/CodegraphDbFiles/issues/writablePathFor)
- **mcp:** make pathPattern examples match what exact picomatch selects (xf01b)
  ([eb8cdaf](https://github.com/artk0de/TeaRAGs-MCP/commit/eb8cdaf1ef5b32c63d3294768bfa59637b1b79e4))
- **pipeline:** contract-only comments in hot enrichment files, fix navigator
  drift (39xca.10)
  ([c4be87f](https://github.com/artk0de/TeaRAGs-MCP/commit/c4be87ff647f246b9f0a83496dd42e42a0b8bba1)),
  closes
  ...
  [CodegraphEnrichmentProvider#onRelease](https://github.com/artk0de/CodegraphEnrichmentProvider/issues/onRelease)
  [WorkerPoolEnrichmentExecutor#releaseRun](https://github.com/artk0de/WorkerPoolEnrichmentExecutor/issues/releaseRun)
- **scripts:** cite symbols, not line numbers, in 16 src navigators (39xca.8)
  ([2f86090](https://github.com/artk0de/TeaRAGs-MCP/commit/2f8609076b101b4881572c35be40ceacfea85b71)),
  closes [Class#method](https://github.com/artk0de/Class/issues/method)
  [Scanner#walkDirectory](https://github.com/artk0de/Scanner/issues/walkDirectory)
  [FileScanner#walkDirectory](https://github.com/artk0de/FileScanner/issues/walkDirectory)
- **website:** redraw the home-page architecture diagram and fix capability
  claims
  ([17d429b](https://github.com/artk0de/TeaRAGs-MCP/commit/17d429bef78be601f2978de2b326e4615ed807a9))

### Code Refactoring

- **contracts:** add branded collection identity and its minting module
  (39xca.1)
  ([e6e447f](https://github.com/artk0de/TeaRAGs-MCP/commit/e6e447f514e0a2a439689f542ad30e60bd289302)),
  closes
  [QdrantAliasManager#listAliases](https://github.com/artk0de/QdrantAliasManager/issues/listAliases)
  [#resolveActive](https://github.com/artk0de/TeaRAGs-MCP/issues/resolveActive)
- **contracts:** require PhysicalCollectionName at storage boundaries (39xca.1)
  ([c43a8f9](https://github.com/artk0de/TeaRAGs-MCP/commit/c43a8f99fce2d17845fe12000e08892535c1d16a))
- **pipeline:** CompletionRunner step dependencies as typed outcomes (39xca.5)
  ([88c1660](https://github.com/artk0de/TeaRAGs-MCP/commit/88c16602a6c1872003aa072b1417bfc10e6a20f3)),
  closes
  [CompletionRunner#run](https://github.com/artk0de/CompletionRunner/issues/run)
- **pipeline:** per-run entries take an EnrichmentRunHandle (39xca.3)
  ([d8b6fc1](https://github.com/artk0de/TeaRAGs-MCP/commit/d8b6fc1ea88af3734d86899661e37a7d6b002328)),
  closes
  [EnrichmentCoordinator#beginRun](https://github.com/artk0de/EnrichmentCoordinator/issues/beginRun)
  [EnrichmentExecutor#releaseCollection](https://github.com/artk0de/EnrichmentExecutor/issues/releaseCollection)
- **trajectory:** split codegraph provider along extraction, finalize, chunk
  seams (39xca.10)
  ([a450a41](https://github.com/artk0de/TeaRAGs-MCP/commit/a450a41fb9557c75d28eccb1150517184f1afd7f))
