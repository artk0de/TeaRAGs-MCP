...
- **Project** — named binding: `production-rails-app` → `/home/user/production-rails-app` → `code_abc123`
- **Group** — set of projects: `production-rails-app` =
  `[production-rails-app, production-rails-app]`
...
```json
{
  ...
  "groups": {
    "production-rails-app": ["production-rails-app", "production-rails-app", "production-rails-app"]
  }
}
```
