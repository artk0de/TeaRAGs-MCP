 ...
 *
 * The barrel hop ({@link reexportOriginFile}) still matters, and for a sharper
 * reason than before. A later pass can now correct a parked file, but only by
 * pinning a SYMBOL — nothing downstream re-answers "which module is this?", so
 * a park naming the barrel instead of the declaring file is an edge nobody
 * fixes.
 *
