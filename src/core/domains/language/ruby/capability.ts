...
export const capability: LanguageCapability = {
  ...
  // walker stays 1: the kernel relocations in 63832af60..main are byte-identical on Ruby — both
  // the walker's extraction and the resolver's targets, measured cross-checkout against
  // 63832af60 (bd tea-rags-mcp-e8wbs; the numbers live in that commit body, not here).
