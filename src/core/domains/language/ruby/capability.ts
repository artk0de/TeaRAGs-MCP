...
export const capability: LanguageCapability = {
  ...
  codegraph: {
    ...
    tech: "13-strategy chain + 4 dispatch components (table/union/cone/dynamic) + 16-grammar DSL catalogue + arity/kwarg-narrowed fan-out (corpus-adaptive p99 cap) + YARD type-source + db/schema.rb column accessors",
  },
  notes:
