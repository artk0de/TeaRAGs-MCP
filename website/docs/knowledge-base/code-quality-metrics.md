---
title: "Code Quality Metrics: Theory & Research"
sidebar_position: 5
---
...
This page surveys the academic foundations, industrial systems, and practical implementation strategies for code quality metrics in the context of code intelligence tools. It covers coupling and dependency metrics, churn and complexity models, composite risk metrics, and defect prediction research — the scientific basis for trajectory enrichment awareness in TeaRAGs.
...
- Henry, S. & Kafura, D. (1981). ["Software Structure Metrics Based on Information Flow."](https://doi.org/10.1109/TSE.1981.231113) *IEEE TSE*.
- Counsell, S. et al. (2010). ["An Evolutionary Study of Fan-in and Fan-out Metrics in OSS."](https://doi.org/10.1109/RCIS.2010.5507329) *IEEE CSMR*.
...
:::tip Key Insight for Blast Radius
Instability `I = Ce / (Ce + Ca)` elegantly combines fan-in and fan-out into a single metric. Modules with low instability (high fan-in relative to fan-out) have the largest blast radius.
:::
...
- He, Z. et al. (2013). ["Using Software Dependency to Bug Prediction."](https://doi.org/10.1155/2013/869356) *Mathematical Problems in Engineering*.
- Qu, Y. et al. (2018). ["node2defect: Using Network Embedding to Improve Software Defect Prediction."](https://doi.org/10.1145/3238147.3240469) *ASE 2018*.
- Zimmermann, T. & Nagappan, N. (2008). ["Predicting Defects Using Network Analysis on Dependency Graphs."](https://doi.org/10.1145/1368088.1368161) *ICSE 2008*.

---

## 2. Churn x Complexity: The Hotspot Model
...
> **Hotspot = High Complexity x High Change Frequency**
...
:::info Empirical Validation
In a case study of 400 KLOC with 89 developers and 18,000+ commits, hotspot analysis identified 7 of 8 most defect-dense modules. **4% of code was responsible for 72% of all defects.**
:::

**References:**

- Tornhill, A. (2015). *Your Code as a Crime Scene.* Pragmatic Bookshelf.
- Tornhill, A. (2024). [*Your Code as a Crime Scene, Second Edition.*](https://pragprog.com/titles/atcrime2/your-code-as-a-crime-scene-second-edition/) Pragmatic Bookshelf.
...
**Filter:** Commits touching more than 50 files are excluded (reorganizations create false positives).
...
- Nagappan, N. & Ball, T. (2005). ["Use of Relative Code Churn Measures to Predict System Defect Density."](https://doi.org/10.1145/1062455.1062514) *ICSE 2005*, pp. 284--292.
...
- Nagappan, N. & Ball, T. (2007). ["Using Software Dependencies and Churn Metrics to Predict Field Failures."](https://doi.org/10.1109/ESEM.2007.27) *ISSRE 2007*.
- Shin, Y. et al. (2010). ["Can Complexity, Coupling, and Cohesion Metrics Be Used as Early Indicators of Vulnerabilities?"](https://doi.org/10.1145/1774088.1774504) *ACM SAC 2010*.
- Rebro, D.A. et al. (2023). ["Source Code Metrics for Software Defects Prediction."](https://arxiv.org/abs/2301.08022) *arXiv:2301.08022*.
...
- Hotspot analysis (complexity x change frequency)
...
| **isHub** | `isHub` | `fanIn > t1 AND fanOut > t2` | Hub files = maximum change risk. Boolean flag. |
| **Cyclomatic Complexity** | `complexity` | tree-sitter AST | Foundation for hotspot model. Every study uses it. |
| **Composite Hotspot** | (preset) | `churn x complexity` | CodeScene proved: 4% code = 72% defects. |
...
| **Change Risk Score** | (preset) | `churn x complexity x blastRadius` | Composite of all three dimensions. |
...
| **CRAP Score** | Risk = complexity x (1 - coverage) | No test coverage data available |
| **Transitive Fan-In** | Cascading blast radius (N levels deep) | Exponential computation cost |

---

## 6. Proposed Reranker Signals

Building on the existing signals in the tea-rags reranker:
...
interface DepsPayload {
  ...
  isHub: boolean;            // importedByCount > t1 AND fanOut > t2
...
### Phase B: importedBy Computation
...
1. Henry, S. & Kafura, D. (1981). ["Software Structure Metrics Based on Information Flow."](https://doi.org/10.1109/TSE.1981.231113) *IEEE TSE*, 7(5), 510--518.
2. Martin, R.C. (2002). *Agile Software Development: Principles, Patterns, and Practices.* Prentice Hall.
3. Nagappan, N. & Ball, T. (2005). ["Use of Relative Code Churn Measures to Predict System Defect Density."](https://doi.org/10.1145/1062455.1062514) *ICSE 2005*, 284--292.
4. Nagappan, N. & Ball, T. (2007). ["Using Software Dependencies and Churn Metrics to Predict Field Failures."](https://doi.org/10.1109/ESEM.2007.27) *ISSRE 2007*.
5. Zimmermann, T. & Nagappan, N. (2008). ["Predicting Defects Using Network Analysis on Dependency Graphs."](https://doi.org/10.1145/1368088.1368161) *ICSE 2008*.
6. Hassan, A.E. (2009). ["Predicting Faults Using the Complexity of Code Changes."](https://doi.org/10.1109/ICSE.2009.5070510) *ICSE 2009*.
7. Shin, Y. et al. (2010). ["Can Complexity, Coupling, and Cohesion Metrics Be Used as Early Indicators of Vulnerabilities?"](https://doi.org/10.1145/1774088.1774504) *ACM SAC 2010*.
8. Counsell, S. et al. (2010). ["An Evolutionary Study of Fan-in and Fan-out Metrics in OSS."](https://doi.org/10.1109/RCIS.2010.5507329) *IEEE CSMR*.
9. He, Z. et al. (2013). ["Using Software Dependency to Bug Prediction."](https://doi.org/10.1155/2013/869356) *Mathematical Problems in Engineering*.
10. Tornhill, A. (2015). *Your Code as a Crime Scene.* Pragmatic Bookshelf.
11. Qu, Y. et al. (2018). ["node2defect: Using Network Embedding to Improve Software Defect Prediction."](https://doi.org/10.1145/3238147.3240469) *ASE 2018*.
12. Rebro, D.A. et al. (2023). ["Source Code Metrics for Software Defects Prediction."](https://arxiv.org/abs/2301.08022) *arXiv:2301.08022*.
13. Tornhill, A. (2024). [*Your Code as a Crime Scene, Second Edition.*](https://pragprog.com/titles/atcrime2/your-code-as-a-crime-scene-second-edition/) Pragmatic Bookshelf.
