...
👉 **[Agentic Data-Driven Engineering](/agent-integration/agentic-data-driven-engineering)** — full strategies, workflows, and the transformation table.
...
flowchart TB
    ...
    subgraph STORE["Qdrant"]
        ...
        payload["Payload: 19 git signals"]
    end
