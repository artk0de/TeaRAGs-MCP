...
describe("RubySuperSymbolResolutionStrategy — MRO ordering (uuux9)", () => {
  ...
  const includeBeatsSuperclassCtx = (): CallContext => ({
    ...
    symbolTable: tableWith(
      ["app/models/base.rb", [sym("Base", "Base", "app/models/base.rb", []), sym("Base#save", "save", "app/models/base.rb", ["Base"])]],
      [
      ...
      ["app/models/sub.rb", [sym("Sub", "Sub", "app/models/sub.rb", []), sym("Sub#save", "save", "app/models/sub.rb", ["Sub"])]],
    ),
  ...
  const twoIncludesCtx = (): CallContext => ({
    ...
    symbolTable: tableWith(
      [
        "app/loggable.rb",
        [sym("Loggable", "Loggable", "app/loggable.rb", []), sym("Loggable#run", "run", "app/loggable.rb", ["Loggable"])],
      ],
