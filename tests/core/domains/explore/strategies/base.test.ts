...
describe("BaseExploreStrategy", () => {
  ...
  // File-level grouping moved out of the strategy hub into
  // chunk-grouping/file-level.ts (tea-rags-mcp-zrma). Its tests moved with it:
  // tests/core/domains/explore/chunk-grouping/file-level.test.ts
