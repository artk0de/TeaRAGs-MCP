...
import { EnrichmentModule } from "../../../src/core/ingest/trajectory/enrichment-module.js";
...
vi.mock("../../../src/core/ingest/trajectory/git/git-log-reader.js", () => ({
...
describe("EnrichmentModule streaming API", () => {
  ...
  describe("fire-and-forget enrichment", () => {
    it("should not block awaitCompletion on slow chunk churn", async () => {
      ...
      // Chunk churn takes forever (simulates production-rails-app hang)
